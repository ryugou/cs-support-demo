...
async fn main() -> Result<()> {
    ...
    let admin_static_dir = resolve_admin_static_dir(&config_dir, &config.admin_static_dir);
    app = app.nest_service("/admin", admin_static_router(&admin_static_dir));
...
fn resolve_admin_static_dir(config_dir: &Path, admin_static_dir: &str) -> PathBuf {
...
fn admin_static_router(dir: &Path) -> axum::Router {
